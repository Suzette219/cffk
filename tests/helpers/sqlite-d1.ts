...
export function createTestDatabase() {
  ...
  for (const migrationName of ["0000_initial.sql", "0001_flowery_doomsday.sql", "0002_glamorous_daimon_hellstrom.sql", "0003_normal_forge.sql", "0004_order_payment_proof.sql", "0005_admin_soft_delete.sql"]) {
